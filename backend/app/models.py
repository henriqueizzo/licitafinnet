...
class Analise(Base):
    ...
    # Análise das duas frentes Finnet (nomes de coluna herdados do schema original)
    score_beneficios: Mapped[int] = mapped_column(Integer, default=0)   # 0-10 Finnet EDI/VAN
    score_pagamentos: Mapped[int] = mapped_column(Integer, default=0)   # 0-10 Finnet Pagamentos
...
PERFIL_PADRAO = {
    "descricao": (
        "FINNET S/A — Tecnologia e Instituição de Pagamento (CNPJ 05.607.266/0001-10, sede em "
        "Barueri/SP). Ecossistema de soluções financeiras em nuvem especializado em troca "
        "eletrônica de dados (EDI — Electronic Data Interchange) e VAN bancária (Value Added "
        "Network): integração entre ERPs (SAP, Totvs, Oracle) e bancos, instituições financeiras "
        "e plataformas de pagamento. Presta serviços de tráfego e gestão de arquivos eletrônicos "
        "bancários (remessa/retorno CNAB, cobrança, pagamentos, extratos, DDA), conciliação "
        "bancária e financeira, automação de contas a pagar e a receber, régua de cobrança e "
        "soluções de pagamento como instituição de pagamento autorizada. Participa de licitações "
        "públicas de órgãos federais, estaduais e municipais, estatais, autarquias (água/"
        "saneamento, gás, energia) e conselhos de classe que precisem trocar arquivos com a rede "
        "bancária. Execução 100% remota/nuvem, com atuação em todo o território nacional. "
        "Histórico público: Caixa Econômica Federal (credenciamento EDI nacional), Bahiagás "
        "(VAN), SAEV Votuporanga/SP (EDI/VAN), CRA-MG (EDI)."
    ),
    "cnaes": [],
    "ufs": [
    ...
    "palavras_chave": [
        ...
        "VAN bancária", "value added network", "dados eletrônicos bancários",
        "tráfego de dados bancários", "arquivos bancários", "remessa e retorno",
        "CNAB", "integração bancária", "conciliação bancária", "conciliação financeira",
        "cobrança bancária", "boleto de cobrança", "arrecadação bancária", "DDA",
        "gestão de pagamentos", "automação financeira", "contas a pagar e receber",
        "instituição de pagamento", "transmissão de arquivos bancários",
    ],
    "restricoes": [
        "Não participamos de licitações que exijam agência ou posto de atendimento físico no município",
        "Não atuamos como banco/instituição financeira (folha de pagamento, conta corrente, crédito ou arrecadação própria)",
        "Não fornecemos hardware, equipamentos ou infraestrutura física local",
        "Não prestamos serviços gráficos de impressão e postagem de boletos/faturas",
        "Não participamos de objetos de vale-alimentação, vale-refeição ou benefícios corporativos",
        "Não atendemos exigência de software instalado on-premise (a solução é 100% em nuvem)",
    ],
    "razao_social": "FINNET S/A - TECNOLOGIA E INSTITUIÇÃO DE PAGAMENTO",
    "cnpj": "05.607.266/0001-10",
    "endereco": "Alameda Araguaia, 2044, Sala 310, Bloco 1, Alphaville Industrial, Barueri/SP, CEP 06455-000",
    "cidade_sede": "Barueri/SP",
    "representante_nome": "",
    "representante_cargo": "",
}
