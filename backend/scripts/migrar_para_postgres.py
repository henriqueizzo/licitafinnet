...
Argumentos:
    origem (posicional, opcional)  Caminho do arquivo SQLite. Default: licitafinnet.db
...
def main() -> None:
    ...
    parser.add_argument("origem", nargs="?", default="licitafinnet.db",
                        help="arquivo SQLite de origem (default: licitafinnet.db)")
