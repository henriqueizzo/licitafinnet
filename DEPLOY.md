# Como colocar o LicitaFinnet no ar (100% gratuito)
...
3. No seu computador, abra o terminal (PowerShell) na pasta do projeto e rode
   ...
   ```powershell
   cd "C:\Users\Henrique Izzo\LicitaFinnet"
   git remote add origin https://github.com/SEU-USUARIO/LicitaFinnet.git
...
```powershell
cd "C:\Users\Henrique Izzo\LicitaFinnet\backend"
...
3. Conecte a sua conta do GitHub e selecione o repositório **LicitaFinnet**
...
6. Ao final, o Render mostra o endereço do sistema, algo como
   `https://licitafinnet.onrender.com`. Abra no navegador e entre com o
...
No seu computador nada muda: o backend usa o SQLite (`backend\licitafinnet.db`)
